...
First Identify the Process Using Port 5432. We can use lsof or netstat to identify which process is using port 5432.
...
This will give you the process ID (PID) of the service using the port.

Stop the Service. Once you have the PID, you can stop the process using the kill command.
